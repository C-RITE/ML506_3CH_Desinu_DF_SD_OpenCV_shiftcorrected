 ...
 *   [out] pbBuf:       Bytes array to hold the string descriptor that is read
 *                      from the device. If dwBufSize < the size of the string
 *                      descriptor, the returned descriptor will be truncated to
 *                      dwBufSize bytes.
 ...
 *                      function will use the first supported language ID
 *                      returned from the device (if exists).
 *   [out] pdwDescSize: If this parameter is not NULL, in case of a successful 
 *                      read the function will update this parameter with the
 *                      size of the string descriptor that was read from the
 *                      device.
 * Return Value:
 *   WinDriver Error Code
 */
